...
export const registerFields = (
  ...
  { model: 'township_id', type: 'select', label: 'Township', placeholder: 'Select Township', options: townships, required: true },
  { model: 'ward_id', type: 'select', label: 'Ward', placeholder: 'Select Ward', options: filteredWards, required: true },
]
